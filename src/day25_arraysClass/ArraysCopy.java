...
public class ArraysCopy {
    public static void main(String[] args) {
        ...
        nums[0] = 10;// reassing the first index to 10
        ...
        // we have two arrays,but we only change the middle element of the first array, but because
