...
public class Library {
    public static void main(String[] args) {
        ...
        book2.hasMovie = true;
        //book2 has access to 8 variables. All of the variables from the parent Book class and the two variables declared in the AudioBook class

        EBook book3 = new EBook();
        book3.size = 24.12;
        book3.onKindle = true;
        //book3.narrator = the narrator was a variable declared in the EBook class
